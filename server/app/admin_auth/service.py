...
class CategoryValidationSchema(BaseValidationSchema):
    ...
class InformationPageValidationSchema(BaseValidationSchema):
    ...
class ServiceValidationSchema(BaseValidationSchema):
    price:int = Field(..., description="Поле должно содержать до 50 символов.")
