...
SECRET_KEY = 'django-insecure-t8erptvum^(72601@*-#*ne8ktuf4qqm4jl!r^9!3)0#$ivs*1'
...
MIDDLEWARE = [
    ...
    'app.authorization.AuthorizationMiddleware',
]
...
CORS_ALLOWED_ORIGINS = [
    'http://26.73.223.97:8000',
    'http://26.73.223.97:5173',
    'http://localhost',
    'http://localhost:5173'
]
